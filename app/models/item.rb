class Item < ApplicationRecord
  ...
  with_options presence: true do
    ...
    validates :user
    validates :price, numericality: { greater_than_or_equal_to: 300, less_than_or_equal_to: 9_999_999, message: ' is out of setting range. Price must be Half-width number' }
  end
